...
export default function OtherCitizenshipPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
            Swiss Citizenship for Third-Country Nationals
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl">
            Your comprehensive guide to Swiss citizenship for citizens from Asia, Africa, Middle East, South America, and all non-EU/EFTA countries.
          </p>
        </div>
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-8">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-900 mb-2">10-Year Journey</h3>
              <p className="text-gray-700">
                As a third-country national, you need 10 years of continuous residence before applying for citizenship. This is a long-term commitment requiring strong integration.
              </p>
            </div>
          </div>
        </div>
          ...
          {[
            {
              ...
              requirements: ['Integration test passed', 'No criminal record', 'Financial independence', 'Respect for Swiss law and values', 'Active community participation'],
            ...
            },
            {
              ...
              requirements: ['Married to Swiss citizen', 'Integration test', 'No criminal record', 'Active community participation', 'Financial stability'],
            ...
            },
            {
              ...
              requirements: ['Born in Switzerland or arrived before age 10', 'Attended school in CH', 'Residence since age 10', 'Integration proven through education'],
              timeline: '4-8 months processing',
              icon: Calendar,
              note: 'For children and young adults'
            },
            {
              path: 'Exceptional Cases',
              residency: '5-10 years (varies)',
              language: 'B1+ required',
              requirements: ['Exceptional integration', 'Outstanding contributions to Switzerland', 'Special circumstances', 'Cantonal and federal approval'],
              timeline: '12-18 months processing',
              icon: Globe,
              note: 'Rare - exceptional circumstances only'
            }
          ].map((path, idx) => (
            <motion.div
              key={idx}
        ...
        >
          <h3 className="text-xl font-bold text-gray-900 mb-3">Important Considerations for Third-Country Nationals</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-2">
              <CheckCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-semibold text-gray-900">10-Year Timeline</p>
                <p className="text-sm text-gray-600">Plan for a full decade of continuous residence before citizenship eligibility</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <CheckCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
              <div>
                ...
                <p className="text-sm text-gray-600">Switzerland allows dual citizenship - check your home country's rules</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <CheckCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
              <div>
                ...
                <p className="text-sm text-gray-600">Strong emphasis on cultural, linguistic, and social integration</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <CheckCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-semibold text-gray-900">Quota Challenges</p>
                <p className="text-sm text-gray-600">Initial permits are quota-restricted - persistence is key</p>
              </div>
            </div>
          </div>
        </motion.div>
