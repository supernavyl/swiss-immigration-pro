        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://images.unsplash.com https://files.stripe.com https://*.swissimmigrationpro.com",
              "font-src 'self'",
              // wss: for VoiceEngine WebSocket; https://ipapi.co for geolocation
              "connect-src 'self' https://api.stripe.com https://ipapi.co wss://*.swissimmigrationpro.com",
